...
onload:function(){setTimeout('GBcZJXC.start()',0)},
...
onmouseover:function(evt){var m=GBcZJXC
...
m.updateDropdownsTimeLagged()}},
onmouseout:function(evt){var m=GBcZJXC
m.cancelDropdownsUpdating()
var e=m.getSource(evt)
if(e)m.out(e)
else{m.lastFoid=0
...
m.updateDropdownsTimeLagged()},
onmouseup:function(evt){var m=GBcZJXC
m.isdown=false
var e=m.getSource(evt)
if(e)m.clicked(e)},
clicked:function(e){var m=GBcZJXC
var it=m.items[e.id]
...
updateDropdownsTimeLagged:function(){this.timeout=window.setTimeout('GBcZJXC.updateDropdowns()',300)},
...
dummy:null};GBcZJXC.dropdown=function(m, itPar, index, level){var f=this
...
f.level=level
f.div.obj=f
f.obj='GBcZJXC.fo'+index
eval(f.obj+'=f')};GBcZJXC.dropdown.prototype={showDropdown:function(){var f=this
var it=f.itPar
var fo=f.div
