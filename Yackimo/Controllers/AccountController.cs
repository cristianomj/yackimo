...
namespace Yackimo.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            WebSecurity.ConfirmAccount(id);
            ViewBag.Message = "Continue Registration.";
        ...
        public ActionResult ExternalLoginConfirmation(RegisterExternalLoginModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                using (YackimoDb db = new YackimoDb())
                {
                    UserProfile user = db.UserProfiles.FirstOrDefault(u => u.UserName.ToLower() == model.UserName.ToLower());
        ...
        private void SendVerificationMail(RegisterModel model, string token)
        {
            var smtp = new SmtpClient
            {
                ...
                Credentials = new NetworkCredential("cristiano-mj@hotmail.com", "cris0725")
            };
            using (var message = new MailMessage("cristiano-mj@hotmail.com", model.Email)
            {
